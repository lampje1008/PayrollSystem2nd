...
/** System for management of employee's pay using LinkedBag. */
public class LinkedBagPayrollSystem {
	public static void main(String[] args) {
		// create five-element Employee bag
		BagInterface<Employee> employees = new LinkedBag<>();
		
		// initialize bag with Employees
		employees.add(new SalariedEmployee("John", "Smith", "111-11-1111", 6, 15, 1944, 6, 15, 1974, 800000.00));
		employees.add(new HourlyEmployee("Karen", "Price", "222-22-2222", 12, 29, 1960, 12, 29, 1990, 16750, 40));
		employees.add(new CommissionEmployee("Sue", "Jones", "333-33-3333", 9, 8, 1954, 9, 8, 1984, 10000000, .06));
		employees.add(new BasePlusCommissionEmployee("Bob", "Lewis", "444-44-4444", 3, 2, 1965, 3, 2, 1995, 5000000, .04, 300000));
		employees.add(new SalariedEmployee("Dongyeon", "Kim", "555-55-5555", 7, 16, 1945, 7, 16, 1975, 900000.00));
		...
		int numberOfEmployees = employees.getCurrentSize();
		for (int i = 0; i < numberOfEmployees; i++) {
			Employee currentEmployee = employees.remove();
